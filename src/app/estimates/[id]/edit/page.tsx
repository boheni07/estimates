      ...
      <div className="bg-white p-4 md:p-6 rounded-2xl border border-slate-200 shadow-sm flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="text-xs font-bold px-2.5 py-1 rounded-lg border border-slate-300 bg-slate-50 focus:ring-1 focus:ring-blue-500"
              >
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <button
            ...
            onClick={handleSave}
            disabled={saving}
            className="inline-flex items-center gap-1.5 px-5 py-2 bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold rounded-xl shadow-md shadow-blue-500/20 transition-all disabled:opacity-50"
          >
